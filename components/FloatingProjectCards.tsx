                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                    ...
                    {selectedProject.ghLink && (
                      ...
                      >
                        <img 
                          src="/Public/icons8-github-64.png" 
                          alt="GitHub" 
